# Functional Python [![](https://github.com/FallynB/functional-python/workflows/tests/badge.svg)](https://github.com/FallynB/functional-python/actions?query=workflow%3Atests)
